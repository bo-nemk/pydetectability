function [noise_psd ]=noise_psdest(noisy_dft_frame, I,speech_psd,noise_psd_old)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
init_per=5; % initial number of frames of noisy wave-file that are assumed to be nosie only


a_post_snr=(abs(noisy_dft_frame).^2)./noise_psd_old;
